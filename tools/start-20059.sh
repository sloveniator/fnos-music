...
#   BIND_IP / PORT / GS_ADMIN_PASSWORD / GS_APP_STATIC_DIR / GS_WEB_STATIC_DIR
#
...
BIND_IP=:: PORT=20059   GS_ADMIN_PASSWORD="$ADMIN_PASS"   GS_APP_STATIC_DIR="$ROOT/ui/app"   GS_WEB_STATIC_DIR="$ROOT/ui/dist"   setsid node ./index.js >> "$LOG" 2>&1 < /dev/null &
